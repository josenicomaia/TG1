...
<html>
    ...
    <body>
        ...
        <header class="site-header push">M&F Soluções em Tecnologia - SysMF</header>
...
$instrucaoSQL = "SELECT $campo1, $campo2, $campo21, $campo22, $campo23, $campo24, $campo25, $campo26,  $campo3, $campo31, $campo4, $campo5, $campo6, $campo7, $campo8, $campo9  FROM $tabela WHERE  $campo9 <> 'Sim' ORDER BY $campo2";
$consulta = mssql_query($instrucaoSQL);
$numRegistros = mssql_num_rows($consulta);

echo "<font size=5 face=Tahoma><b>Relação de Clientes Inativos</b><br></font>";
...
<footer class="site-footer push">Copyright - M&F Soluções em Tecnologia - 2017</footer>
