        ...
        <?php 
          ...
          $valortotal = (($valortotal) + ($linhas['valor']));
            ...
            if ($linhas['estagio'] == 4) {
              ...
              $linhas['estagio'] = "Fechada";
            }
            if ($linhas['estagio'] == 5) {

              $linhas['estagio'] = "F.Sem Resposta";
            }
            if ($linhas['estagio'] == 6) {

              $linhas['estagio'] = "F. Perdida";
            }
        ...
        ?>
          ...
          <table class="table table-sm">
                ...
                <tr>
                 ...
                 <td class="table-light text-right"><b> Valor Total: R$ <?php echo number_format($valortotal, 2, ',', '.'); ?></b></td>
