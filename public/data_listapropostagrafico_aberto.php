...
<html lang="pt-br">
    ...
    <body>
	   <div class="starter-template">
         <h3>Visualizar gráfico - Propostas em aberto</h3>
         <br />
            <div class="container text-center">
                <form class="form-signin" method="POST" action="graficopropostas_aberta.php">
                    ...
                    <button class="btn btn-lg btn-outline-primary btn-block" type="submit">Visualizar</button>
                </form>
            </div>
        </div>
    </body>
