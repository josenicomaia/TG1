...
<html lang="pt-br">
    ...
    $sql = $mysqli->query("INSERT INTO propostas (arquivos, valor, estagio, numero, descricao, datacriacao, contato, email, cliente_uid, resumo, tiposervico) VALUES ('$arquivos', '$valor', '$estagio', '$numero', '$descricao', NOW(), '$contato', '$email', '$uid_cliente', '$resumo', '$tiposervico')");
