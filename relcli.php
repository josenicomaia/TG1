...
$instrucaoSQL = "SELECT $campo1, $campo2, $campo21, $campo22, $campo23, $campo24, $campo25, $campo26,  $campo3, $campo31, $campo4, $campo5, $campo6, $campo7, $campo8, $campo9  FROM $tabela WHERE  $campo7 in (1,2,3) and $campo9 = 'Sim' ORDER BY $campo2";
